...
public class fullTest {
	...
	public void addProvider() throws InterruptedException {
		...
		businessContactName.sendKeys("DemoQATest");
		Thread.sleep(1000);
		...
		providerName.sendKeys("Demo QA Test");
		Thread.sleep(1000);

		WebElement bussinessEmail = driver.findElement(By.id("email"));
		bussinessEmail.sendKeys("vickyrajas1997+qa-prv-test@gmail.com");
		Thread.sleep(1500);
